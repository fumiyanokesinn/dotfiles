...
brew "zoxide"
# CLI-based Pomodoro timer written in Go
brew "fumiyanokesinn/tap/pomodoro"
...
go "golang.org/x/review/git-codereview"
go "github.com/fumiyanokesinn/go-cli-tutor"
